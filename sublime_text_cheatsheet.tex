...
\keys{\cmd+K}, \keys{\cmd+B} Toggle Sidebar \\
...
\keys{g} Most of \keys{g}'s power is not implemented in Vintage Mode. You can use the basic combinations \keys{gg} and \keys{G} to move to the top/bottom of the file. \keys{number}, \keys{gg}/\keys{G} to move to that line. \\
